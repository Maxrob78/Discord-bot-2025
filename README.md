...
Le bot élimine la saisie manuelle fastidieuse. En analysant les captures d'écran des compositions, il extrait automatiquement :
* **Les joueurs**
* **Leurs postes**
* **Leurs notes**
...
| **EasyOCR** | Moteur de traitement d'images pour l'extraction de données. |
